...
//extern char* uhid_device_name;
extern bool kill_resquested;
extern int i2c_fd, i2c_fd_sec, i2c_adc_fd[];
bool i2c_bus_failed = false;
int i2c_bus_err = 121, i2c_main_err = 121, i2c_sec_err = 121, i2c_adc_err[] = {121, 121, 121, 121};
