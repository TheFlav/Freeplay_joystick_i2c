...
static void adc_data_compute(int /*adc_index*/); //compute adc max value, flat in/out, offset
...
bool diag_mode_init = false/*, cfg_save = false*/;
...
//I2C related
int i2c_bus = def_i2c_bus, i2c_bus_back = -1; //I2C bus
int i2c_addr = def_i2c_addr, i2c_addr_back = -1; //main MCU I2C address
int i2c_addr_sec = def_i2c_addr_sec, i2c_addr_sec_back = -1; //secondary MCU I2C address
...
int i2c_addr_adc_back[] = {-1, -1, -1, -1}; //external ADC I2C address, set to 0xFF to disable
...
cfg_vars_t cfg_vars[] = {
	...
	{"\nadc0_i2c_enabled", adc_enabled_desc, 4, &adc_params[0].enabled},
	...
	{"\nadc1_i2c_enabled", adc_enabled_desc, 4, &adc_params[1].enabled},
	...
	{"\nadc2_i2c_enabled", adc_enabled_desc, 4, &adc_params[2].enabled},
	...
	{"\nadc3_i2c_enabled", adc_enabled_desc, 4, &adc_params[3].enabled},
