...
#define battery_rsoc_file "/sys/class/power_supply/battery/capacity" //full path to sysfs battery rsoc (battery state in percent), require a battery jauge and a "power supply" compatible kernel driver, "ALLOW_MCU_SEC_I2C" needs to be defined in compilation command line
