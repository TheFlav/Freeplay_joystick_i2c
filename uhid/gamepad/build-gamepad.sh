...
gcc -march=armv6 -mfpu=vfp -mfloat-abi=hard -DUSE_WIRINGPI -o uhid-i2c-gamepad nns_config.c uhid-i2c-gamepad.c -li2c -lwiringPi

#compile with libGPIOd IRQ
#gcc -march=armv6 -mfpu=vfp -mfloat-abi=hard -DUSE_GPIOD -o uhid-i2c-gamepad nns_config.c uhid-i2c-gamepad.c -li2c -lgpiod

#compile diagnostic program
gcc -march=armv6 -mfpu=vfp -mfloat-abi=hard -DDIAG_PROGRAM -o uhid-i2c-gamepad-diag nns_config.c driver_diag.c uhid-i2c-gamepad.c -li2c
