...
doUSBtest = 0
btn_test_skip_list = {'c', 'z', 'tl2', 'tr2', 'thumbl', 'thumbr'}
...
os.system("raspi-gpio set 10 ip");

print ""
print ""
print ""
print "RED battery LED should be OFF"
btn_test('a', 1)

os.system("raspi-gpio set 10 op dl");
print ""
print ""
print ""
print "RED battery LED should be ON"
btn_test('a', 1)
os.system("raspi-gpio set 10 ip");
...
print ""
print ""
print "BACKLIGHT DIMMER TESTS (OFF, ON, DIMM, ON)"
btn_test('a', 1)

os.system("echo 1 > /dev/shm/uhid_i2c_driver/0/lcd_sleep_mode");
print ""
print ""
print ""
...
while (btn_num < num_buttons) :
  if (button_map[btn_num] not in btn_test_skip_list) :
...
print ""
print "Tests Complete!  Press A to kill power now."
#print "  Starting EmulationStation"
btn_test('a', 1)

os.system("i2cset -y 0 0x40 0x0A 0x55");
os.system("i2cset -y 0 0x40 0x02 0x81");
